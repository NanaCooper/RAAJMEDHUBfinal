        ...
        <View style={styles.root}>
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.header}>
                    <TouchableOpacity onPress={() => router.push({ pathname: '/(doctor)/appointments', params: { tab: 'book' } })} style={styles.backBtn}>
                ...
                >
                    ...
                    {!uploadedImage && (
                        <>
                            {/* Patient Type Toggle */}
                            {/* Toggle removed: Forced to Someone Else */}
...
const styles = StyleSheet.create({
    ...
    viewport: {
        flex: 1, backgroundColor: '#F8FAFC', borderRadius: 24, overflow: 'hidden',
    ...
    cameraBtn: {
        ...
        overflow: 'hidden', // Fix: prevents gradient from bleeding out
    },
